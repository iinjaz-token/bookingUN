...
{	
    ...
    public function CustomerRegister(Request $request)
    {
        ...
        if ($response) {
            ...
            return redirect()->back()->withFail(__('Oops! You failed to register. Please try again.'));
        }
    }
    ...
    protected function resetPassword(Request $request) {
        ...
        if ($userCount < 1) {
            return redirect()->back()->withFail(__('We cannot find a user with that email address'));
        }
        ...
        if ($sendResetEmail == 1) {
            ...
            return redirect()->back()->withFail(__('Oops! You failed to change password request. Please try again'));
        }
    }
    ...
    public function resetPasswordUpdate(Request $request) {
        ...
        if ($userCount == 0) {
            ...
            if ($response) {
                ...
                return redirect()->back()->withFail(__('Oops! You failed to change password. Please try again'));
            }
        }
    }
